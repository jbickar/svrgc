Feature: Bullseye Pistol Content
  In order to ensure that the Sunnyvale Rod & Gun Club website has the correct content
  As an end user
  I want to check for the existence of content that should appear on the activities/bullseye page

  @safe
  Scenario: Bullseye Pistol Headings
    Given I am on "activities/bullseye"
    Then I should see the heading "Bullseye Pistol"
    And I should see the heading "Introduction to the League"
    ...
    And I should see the heading "22 Rimfire"
    And I should see the heading "Center Fire"
    And I should see the heading "Firearms"
